...
public class RSA {
	...
	public static final String SIGN_RSA256_ALGORITHMS = "SHA256WithRSA";
	...
	public static String sign256(String content, String privateKey, String input_charset) {
		try {
			...
			java.security.Signature signature = java.security.Signature.getInstance(SIGN_RSA256_ALGORITHMS);
